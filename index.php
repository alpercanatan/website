...
<!-- Kullanıcı Girişi ve Kayıt olma Kodu Baslangıc -->
       ...
       <!-- Kullanıcı Girişi ve Kayıt olma Kodu SON -->        
        ...
        <!--[if lt IE 10]><script type="text/javascript" src="https://cdn.jsdelivr.net/gh/eligrey/classList.js@1.1.20170427/classList.min.js"></script><![endif]-->
           ...
           <!-- WhatsApp API Direk Bağlıntı Kod Baslangıc -->    
               
               
               
               <a href="https://api.whatsapp.com/send?phone=<?php echo $ayarcek['ayar_gsm']; ?>&amp;text=Merhaba Web Site Kullanıcısı" title="WhatsApp ile Sor" class="whatsapp_sor"><i class="ion-social-whatsapp-outline"></i>  WhatsApp ile Sor</a>
...
.whatsapp_sor {
  ...
  text-decoration:none;
           ...
           <!-- WhatsApp API Direk Bağlıntı Kod Sonu -->
